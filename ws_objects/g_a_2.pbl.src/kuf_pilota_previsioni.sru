...
private string ki_temptab_pilota_workqueue 
...
//--- popola pallet in lav e in coda in una tabella di appoggio: #vx_pilota_prev_lav
		k_righe = u_set_temptable_pilota_prev_lav_x( )
...
//	   	kguo_sqlca_db_magazzino.db_crea_table( ki_temptab_pilota_workqueue, k_campi)      
		...
		kguf_data_base.u_set_ds_change_name_tab(kds_out, "vx_MAST_pilota_pallet_workqueue", ki_temptab_pilota_workqueue)
...
//--- add minuti carico	
					...
					u_set_dataora_lav_prev_fin_1x(kds_queue, k_riga)  // imposta la data di fine lav prevista
...
//	   	kguo_sqlca_db_magazzino.db_crea_table( ki_temptab_pilota_prev_lav, k_campi)      
		...
		kguf_data_base.u_set_ds_change_name_tab(kds_inp, "vx_MAST_pilota_pallet_workqueue", ki_temptab_pilota_workqueue)
