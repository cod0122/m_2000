	...
	choose case tab_1.selectedtab 
		...
		case  1 
			...
			if len(trim(dw_tipo.object.tipo[1])) > 0 then
				...
				dw_tipo.object.tipo[1] = kiuf_clienti.kki_tipo_fatturato 
...
if tab_1.tabpage_1.dw_1.getnextmodified(0, primary!) > 0 	then
	...
	tab_1.tabpage_1.dw_1.setitem(k_riga, "tipo", dw_tipo.object.tipo[1])
...
type dw_trova from w_g_tab_3`dw_trova within w_clienti_rid
integer x = 1705
integer y = 304
end type

type dw_filtra from w_g_tab_3`dw_filtra within w_clienti_rid
end type
