$PBExportHeader$w_stampe_1.srw
forward
global type w_stampe_1 from w_g_tab
end type
type dw_print from datawindow within w_stampe_1
end type
type dw_personalizza from datawindow within w_stampe_1
end type
end forward
...
type st_stampa from w_g_tab`st_stampa within w_stampe_1
integer x = 1138
integer y = 1192
end type

type st_ritorna from w_g_tab`st_ritorna within w_stampe_1
integer x = 709
integer y = 1136
end type
