...
if tab_1.selectedtab = 1 then
	...
	kidw_tabselezionato.ki_flag_modalita = kkg_flag_modalita.visualizzazione 
	
//--- Protezione campi
	kuf1_utility = create kuf_utility
	kuf1_utility.u_proteggi_dw("1", 0, kidw_tabselezionato)
...
kst_esito = aggiorna_dw (tab_1.tabpage_2.dw_2,  tab_1.tabpage_2.text)
if kst_esito.esito <> "0" then
	if k_errore = "0" then
		k_errore = trim(kst_esito.esito)
	else
...
kst_esito = aggiorna_dw (tab_1.tabpage_3.dw_3,  tab_1.tabpage_3.text)
if kst_esito.esito <> "0" then
	if k_errore = "0" then
		k_errore = trim(kst_esito.esito)
	else
...
kst_esito = aggiorna_dw (tab_1.tabpage_4.dw_4,  tab_1.tabpage_4.text)
if kst_esito.esito <> "0" then
	if k_errore = "0" then
		k_errore = trim(kst_esito.esito)
	else
...
kst_esito = aggiorna_dw (tab_1.tabpage_5.dw_5,  tab_1.tabpage_5.text)
if kst_esito.esito <> "0" then
	if k_errore = "0" then
		k_errore = trim(kst_esito.esito)
	else
...
kst_esito = aggiorna_dw (tab_1.tabpage_6.dw_6,  tab_1.tabpage_6.text)
if kst_esito.esito <> "0" then
	if k_errore = "0" then
		k_errore = trim(kst_esito.esito)
	else
...
kst_esito = aggiorna_dw (tab_1.tabpage_7.dw_7,  tab_1.tabpage_7.text)
if kst_esito.esito <> "0" then
	if k_errore = "0" then
		k_errore = trim(kst_esito.esito)
	else
...
kst_esito = aggiorna_dw (tab_1.tabpage_8.dw_8,  tab_1.tabpage_8.text)
if kst_esito.esito <> "0" then
	if k_errore = "0" then
		k_errore = trim(kst_esito.esito)
	else
...
kst_esito = aggiorna_dw (tab_1.tabpage_9.dw_9,  tab_1.tabpage_9.text)
if kst_esito.esito <> "0" then
	if k_errore = "0" then
		k_errore = trim(kst_esito.esito)
	else
...
//--- Aggiornamento dei dati inseriti/modificati
	...
	if tab_1.tabpage_1.dw_1.u_dati_modificati() then
		k_boolean = true
		ki_dw_titolo_modif_1 = trim(tab_1.tabpage_1.dw_1.title)
	end if

	 if tab_1.tabpage_2.dw_2.u_dati_modificati() then
		k_boolean = true
		if len(ki_dw_titolo_modif_1) > 0 then
			ki_dw_titolo_modif_1 = ""
		else
			ki_dw_titolo_modif_1 = trim(tab_1.tabpage_2.dw_2.title)
		end if
	end if
	if tab_1.tabpage_3.dw_3.u_dati_modificati() then
		k_boolean = true
		if len(ki_dw_titolo_modif_1) > 0 then
			ki_dw_titolo_modif_1 = ""
		else
			ki_dw_titolo_modif_1 = trim(tab_1.tabpage_3.dw_3.title)
		end if
	end if
	if tab_1.tabpage_4.dw_4.u_dati_modificati() then
		k_boolean = true
		if len(ki_dw_titolo_modif_1) > 0 then
			ki_dw_titolo_modif_1 = ""
		else
			ki_dw_titolo_modif_1 = trim(tab_1.tabpage_4.dw_4.title)
		end if
	end if
	if tab_1.tabpage_5.dw_5.u_dati_modificati() then
		k_boolean = true
		if len(ki_dw_titolo_modif_1) > 0 then
			ki_dw_titolo_modif_1 = ""
		else
			ki_dw_titolo_modif_1 = trim(tab_1.tabpage_5.dw_5.title)
		end if
	end if
	if tab_1.tabpage_6.dw_6.u_dati_modificati() then
		k_boolean = true
		if len(ki_dw_titolo_modif_1) > 0 then
			ki_dw_titolo_modif_1 = ""
		else
			ki_dw_titolo_modif_1 = trim(tab_1.tabpage_6.dw_6.title)
		end if
	end if
	if tab_1.tabpage_7.dw_7.u_dati_modificati() then
		k_boolean = true
		if len(ki_dw_titolo_modif_1) > 0 then
			ki_dw_titolo_modif_1 = ""
		else
			ki_dw_titolo_modif_1 = trim(tab_1.tabpage_7.dw_7.title)
		end if
	end if
	if tab_1.tabpage_8.dw_8.u_dati_modificati() then
		k_boolean = true
		if len(ki_dw_titolo_modif_1) > 0 then
			ki_dw_titolo_modif_1 = ""
		else
			ki_dw_titolo_modif_1 = trim(tab_1.tabpage_8.dw_8.title)
		end if
	end if
	if tab_1.tabpage_9.dw_9.u_dati_modificati() then
		k_boolean = true
		if len(ki_dw_titolo_modif_1) > 0 then
			ki_dw_titolo_modif_1 = ""
		else
			ki_dw_titolo_modif_1 = trim(tab_1.tabpage_9.dw_9.title)
		end if
	end if
...
long k_riga
	...
	k_riga = kuf1_data_base.dw_importfile(trim(ki_syntaxquery), tab_1.tabpage_1.dw_1) 
...
//---
	...
	if kidw_tabselezionato.ki_flag_modalita > " " then
	else
		kidw_tabselezionato.ki_flag_modalita = ki_st_open_w.flag_modalita 
	end if
	kidw_tabselezionato.event u_personalizza_dw()
	kidw_tabselezionato.setfocus( )
...
if not isvalid(kdw_1) then
	...
	if kdw_1.rowcount() > 0 then
		...
		ast_stampe.dw_print = kdw_1
		ast_stampe.titolo = trim(k_titolo) + " di '" + trim(kwindow_1.title) + "'"
	
		k_errore = string(kuf1_data_base.stampa_dw(ast_stampe))
	else
...
//--- Posiziona dw nella window 
	...
	constant int kk_width = 50
	constant int kk_height = 150
...
//		tab_1.tabpage_2.y = 1
		...
		tab_1.tabpage_2.dw_2.height = tab_1.tabpage_2.height - kk_height
...
//kuf1_data_base.dw_saveas(trim(ki_syntaxquery), tab_1.tabpage_1.dw_1)
...
//=== Se sono sulla lista con il mouse allora posiziono il punt sul rek puntato
	choose case ki_tab_1_index_new //tab_1.selectedtab
		...
		case 3
			k_stringa = tab_1.tabpage_3.dw_3.GetObjectAtPointer()
		case 4
			k_stringa = tab_1.tabpage_4.dw_4.GetObjectAtPointer()
		case 5
			k_stringa = tab_1.tabpage_5.dw_5.GetObjectAtPointer()
		case 6
			k_stringa = tab_1.tabpage_6.dw_6.GetObjectAtPointer()
		case 7
			k_stringa = tab_1.tabpage_7.dw_7.GetObjectAtPointer()
		case 8
			k_stringa = tab_1.tabpage_8.dw_8.GetObjectAtPointer()
		case 9
			k_stringa = tab_1.tabpage_9.dw_9.GetObjectAtPointer()
	end choose
	if k_stringa <> "" then
...
//--- chiama l'evento padre
super::event rbuttonup (flags, xpos, ypos)
...
event rbuttondown;call super::rbuttondown;// da personalizzare
...
visualizza() 
u_personalizza_dw ()
if isvalid(kidw_tabselezionato) then kidw_tabselezionato.ki_flag_modalita = ki_st_open_w.flag_modalita
...
//		end if
 ...
 //--- solo se faccio 'inserisci' sul primo tabulatore controlla se ho fatto modifiche
	u_get_dw( )
	if kidw_tabselezionato.u_get_tipo( ) = kidw_tabselezionato.kki_tipo_processing_form then
		k_esito = dati_modif(parent.title)
		if len(k_esito) > 0 then 
			k_errore = left(k_esito, 1)
		end if
...
event ue_rbuttonup;//
parent.event rbuttonup(flags, xpos, ypos)
...
//
if cb_visualizza.enabled = true then 
	cb_visualizza.event clicked( )  // postevent(clicked!)
end if
