...
THIS.Object.item_picture[ll_row] = kg_path_risorse + "\" + as_picture
...
if len(trim(k_picture)) > 0 then
	THIS.Object.item_picture[k_riga] = kg_path_risorse + "\" + k_picture
else
...
//
this.object.p_collapsedhover.filename = kg_path_risorse + "\" + "XPListBarCollapsedHover.bmp"
this.object.p_expandedhover.filename = kg_path_risorse + "\" + "XPListBarExpandedHover.bmp"
this.object.p_expanded.filename = kg_path_risorse + "\" + "XPListBarExpanded.bmp"
this.object.p_collapsed.filename = kg_path_risorse + "\" + "XPListBarCollapsed.bmp"
this.object.p_side.filename = kg_path_risorse + "\" + "XPListBarSide.bmp"
...
kuf1_data_base.dw_ripri_righe("*", kds_1, this.title)
...
//--- salva l'elenco delle parole cercate (passa da DW)
		...
		k_rc=kds_1.Filter()
		k_rc=kuf1_data_base.dw_salva_righe("*", kds_1, this.title)
