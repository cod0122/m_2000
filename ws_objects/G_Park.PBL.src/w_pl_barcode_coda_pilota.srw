...
protected subroutine attiva_menu ();
	...
	kG_menu.m_strumenti.m_fin_gest_libero1.text = "&Sposta Bancali"
	...
	kG_menu.m_strumenti.m_fin_gest_libero1.toolbaritemtext = "Sposta,"+&
...
//	kG_menu.m_strumenti.m_fin_gest_libero2.toolbaritembarindex = 2
	...
	kG_menu.m_strumenti.m_fin_gest_libero3.text = "Elenco &Modificati"
	...
	kG_menu.m_strumenti.m_fin_gest_libero3.toolbaritemtext = "Modifiche,"+&
...
//	kG_menu.m_strumenti.m_fin_gest_libero3.toolbaritembarindex = 2
	...
	kG_menu.m_strumenti.m_fin_gest_libero4.text = "Elenco &Rimossi"
	...
	kG_menu.m_strumenti.m_fin_gest_libero4.toolbaritemtext = "Rimossi," +&
	                               kG_menu.m_strumenti.m_fin_gest_libero4.text
//	kG_menu.m_strumenti.m_fin_gest_libero4.toolbaritembarindex = 4
	...
	kG_menu.m_strumenti.m_fin_gest_libero5.text = "&Invia Programmazione al Pilota"
	...
	if ki_st_open_w.flag_modalita = kkg_flag_modalita_modifica &
		or ki_st_open_w.flag_modalita = kkg_flag_modalita_inserimento  then
		kG_menu.m_strumenti.m_fin_gest_libero5.enabled = true
	else
		kG_menu.m_strumenti.m_fin_gest_libero5.enabled = false
	end if
	kG_menu.m_strumenti.m_fin_gest_libero5.toolbaritemtext = "Invia,"+&
	...
	kG_menu.m_strumenti.m_fin_gest_libero6.text = "Dettaglio &Barcode"
   ...
   "Visualizza dettaglio del Barcode"
	...
	kG_menu.m_strumenti.m_fin_gest_libero6.enabled = true
	kG_menu.m_strumenti.m_fin_gest_libero6.toolbaritemtext = "Barcode,"+&
...
//	kG_menu.m_strumenti.m_fin_gest_libero6.toolbaritembarindex = 2
	...
	if ki_st_open_w.flag_primo_giro = 'S' then
		kG_menu.m_strumenti.m_fin_gest_libero1.toolbaritemname = "Move5!"
		kG_menu.m_strumenti.m_fin_gest_libero2.toolbaritemname = ki_path_risorse + "\cicli.bmp"
		kG_menu.m_strumenti.m_fin_gest_libero3.toolbaritemname = "Form!"
		kG_menu.m_strumenti.m_fin_gest_libero4.toolbaritemname = "Error!"
		kG_menu.m_strumenti.m_fin_gest_libero5.toolbaritemname = "OleGenReg!"
		kG_menu.m_strumenti.m_fin_gest_libero6.toolbaritemname = ki_path_risorse + "\barcode.bmp"
	end if
...
//--- Personalizzo da qui
	...
	case "l1"		//espone il DW x sposta righe
		if dw_sposta.visible then
			dw_sposta.visible = false
			dw_dett_0.setfocus()
		else
			dw_sposta.x = this.width  / 2
			dw_sposta.y = this.height * 0.15
			dw_sposta.visible = true
			dw_sposta.setfocus( )
			dw_sposta.bringtotop=true
		end if
...
try
	...
	if messagebox ("Invio Programmazione Impianto", &
		...
		kuo1_exception.set_tipo(kuo1_exception.KK_st_uo_exception_tipo_generico)
		kuo1_exception.setmessage("Nessun Dato Inviato.~n~r" &
	...
	//--- controlla se Programmazione OK		
			...
			if LeftA(k_errore, 1) <>  "0" then
				...
				kuo1_exception.set_tipo(kuo1_exception.KK_st_uo_exception_tipo_dati_anomali)
				kuo1_exception.setmessage(MidA(k_errore, 2) )
				throw kuo1_exception
...
//--- toglie i barcode cancellati anche dalla Pianificazione
					...
					kuo1_exception.set_tipo(kuo1_exception.KK_st_uo_exception_tipo_dati_anomali)
					kuo1_exception.setmessage("Nessun Bancale estratto.~n~r" &
...
kuf_barcode kuf1_barcode
	...
	if ki_st_open_w.flag_modalita <> kkg_flag_modalita_modifica &
		and ki_st_open_w.flag_modalita <> kkg_flag_modalita_inserimento then
...
if kguo_sqlca_db_pilota.sqlcode <> 0 then
	...
	if kguo_sqlca_db_pilota.sqlcode < 0 then
		kuo_exception = create uo_exception
		kuo_exception.set_tipo(kuo_exception.KK_st_uo_exception_tipo_db_ko)
		kuo_exception.setmessage("Errore durante lettura Coda Pilota~n~r"&
...
//--- Insert tra i Modificabili...
	...
	if kguo_sqlca_db_pilota.sqlcode < 0 then
		kuo_exception = create uo_exception
		kuo_exception.set_tipo(kuo_exception.KK_st_uo_exception_tipo_db_ko)
		kuo_exception.setmessage("Errore durante lettura Coda Pilota Intoccabili~n~r"&
					+ "Codice errore: " +  string(kguo_sqlca_db_pilota.sqlcode) + "~n~r" &
					+ trim(kguo_sqlca_db_pilota.sqlerrtext)&
					)
...
//	kuf1_artr = create kuf_artr
	...
	//--- cancello barcode	anche dal P.L.
	...
	//--- cancello groupage dal padre
		kuf1_barcode.tb_togli_figlio_al_padre (kst_tab_barcode)
...
//--- Toglie anche eventuali FIGLI dalla Programmazione
	...
	//--- cancello barcode	come Figlio dal Padre e dal P.L.
				kuf1_barcode.tb_togli_figlio(kst_tab_barcode_figli)
...
//--- controlla che tutti i barcode sul PILOTA siano PRESENTI anche nelle DW di SPOSTAMENTO+INTOCCABILI+CANCELLATI
	for k_riga = 1 to dw_pilota.rowcount()
...
//=== set transobject per il DB del Pilota
dw_lista_0.settransobject(kguo_sqlca_db_pilota)
dw_dett_0.settransobject(kguo_sqlca_db_pilota)
...
//--- disattiva il comp standard di selezione righe
dw_lista_0.ki_attiva_standard_select_row = false
...
type dw_trova from w_g_tab0`dw_trova within w_pl_barcode_coda_pilota
end type

type dw_filtra from w_g_tab0`dw_filtra within w_pl_barcode_coda_pilota
integer x = 2213
integer y = 604
end type
...
event dw_dett_0::ue_lbuttondown;//
long k_ctr
long k_Height
...
event dw_dett_0::ue_lbuttonup;//
		this.triggerevent ("ue_lbuttonup_post")
	

end event

event dw_dett_0::ue_lbuttonup_post();//
...
event dw_dett_0::ue_dragleave_post();//
ki_riga_selected= 0
...
event dw_dett_0::ue_dwnmousemove;//
