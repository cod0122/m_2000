...
private function long of_run (string as_exefullpath, unsignedlong ai_showwindow)
public function long of_run (string as_exepath, windowstate a_windowstate)
public function long of_run (string as_exepath, trigevent a_windowstate)
end prototypes

public subroutine of_set_options (boolean ab_terminate, decimal adec_seconds);// -----------------------------------------------------------------------------
// SCRIPT:     .of_set_options
//
...
ULong lul_null, lul_CreationFlags, lul_msecs
Ulong lul_ExitCode
long k_return
String ls_null
...
CHOOSE CASE a_windowstate
	...
	//	li_rtn = run(as_exepath, Minimized!)
END CHOOSE
