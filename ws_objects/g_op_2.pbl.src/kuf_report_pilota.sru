...
public function datastore u_get_barcode_queue_all_data () throws uo_exception
...
private function long u_set_report_2_pilota_queue_data_prev () throws uo_exception
private subroutine u_set_report_2_pilota_queue_data_prev_1 (long k_riga) throws uo_exception
private function long u_set_report_24_pilota_prev_lav () throws uo_exception
private function long u_set_report_3_pilota_pallet_in_lav () throws uo_exception
private function datastore u_get_barcode_queue () throws uo_exception
private function long u_set_temptable_pilota_prev_lav () throws uo_exception
public function datastore u_get_prev_lav_x_lotto () throws uo_exception
public function datastore u_get_barcode_queue_some_data () throws uo_exception
end prototypes
...
try 
	...
	if u_set_report_3_pilota_pallet_in_lav() > 0 then
...
//--- Oltre alla riga stessa aggiorna se ci sono eventuali righe di gorupage che hanno lo stesso numero 'ordine', ripete2 volte xchè queste viaggiano sempre in coppia
					...
					do while k_ctr < 3 and  k_riga <= k_righe
						do while k_ordine_queue = kids_d_report_2_pilota_queue_table.getitemnumber(k_riga, "ordine") 
							...
							u_set_report_2_pilota_queue_data_prev_1(k_riga)
							k_riga ++
...
public function datastore u_get_prev_lav_x_lotto () throws uo_exception;//---
//--- Legge i barcode in lavoraz. e programmazione nel PILOTA calcola le prev di inizio e fine lav per Lotto
//---
//
int k_rc, k_ctr
long k_rows
...
try 
	...
	u_set_report_24_pilota_prev_lav( )
...
public function datastore u_get_barcode_queue_some_data () throws uo_exception;//---
//--- Legge i barcode in programmazione nel PILOTA e add alcuni data from M2000
//---
//
int k_rc
long k_rows
