...
Decimal	ld_average
String	ls_return
//iu_powerfilter_dropdown.iw_parent.event dynamic ue_testmessage('of_getaverage START')
...
//iu_powerfilter_dropdown.iw_parent.event dynamic ue_testmessage('of_getaverage END')
Return ld_average
end function
