...
//--- scompatta il campo note, inserimento solo su UNA riga, la prima
					if not k_trovate_note_lotto then
						if len(trim(kst_wm_pkl_web[k_file_ind].note_lotto )) > 510 then
							k_trovate_note_lotto = true
							kst_tab_wm_receiptgammarad[1].note_3 = mid(trim(kst_wm_pkl_web[k_file_ind].note_lotto ),511,255)
							kst_tab_wm_receiptgammarad[1].note_2 = mid(trim(kst_wm_pkl_web[k_file_ind].note_lotto ),256,255)
							kst_tab_wm_receiptgammarad[1].note_1 = left(trim(kst_wm_pkl_web[k_file_ind].note_lotto ),255)
						else
							kst_tab_wm_receiptgammarad[1].note_3 = ""
							if len(trim(kst_wm_pkl_web[k_file_ind].note_lotto )) > 255 then
								k_trovate_note_lotto = true
								kst_tab_wm_receiptgammarad[1].note_2 = mid(trim(kst_wm_pkl_web[k_file_ind].note_lotto ),256,255)
								kst_tab_wm_receiptgammarad[1].note_1 = left(trim(kst_wm_pkl_web[k_file_ind].note_lotto ),255)
							else
								kst_tab_wm_receiptgammarad[1].note_2 = ""
								if len(trim(kst_wm_pkl_web[k_file_ind].note_lotto )) > 0 then
									k_trovate_note_lotto = true
									kst_tab_wm_receiptgammarad[1].note_1 = left(trim(kst_wm_pkl_web[k_file_ind].note_lotto ),255)
								else
...
//------------------------------------------------------------------------------------------------------------------------------------
//---
//--- 	Importa Packing-List grezzo da file XML nella Tabella del DB di MAGAZZINO-WAREHOUSE-MANAGEMENT
//---	ReceiptGammarad
//---
...
//--- Leggo il file 
	...
	//--- Imposta nell'area ReceiptGammarad le Packing-list in formato XML 
