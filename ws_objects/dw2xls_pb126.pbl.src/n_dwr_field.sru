...
public function long of_get_col_height_font (integer ai_col_width, string str, string font_name, boolean font_italic, integer font_underline, integer font_weight, integer font_size);return inv_book.ws.wf_get_col_height_font(ai_col_width, str, font_name, font_italic, font_underline, font_weight, font_size, ii_units)
end function
