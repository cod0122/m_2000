$PBExportHeader$kuf_listino_cambio_stato.sru
forward
global type kuf_listino_cambio_stato from kuf_listino
end type
end forward

global type kuf_listino_cambio_stato from kuf_listino
end type
global kuf_listino_cambio_stato kuf_listino_cambio_stato

type variables
//---
//--- Solo x gestione Autorizzazioni Funzione 
//--- Funzione: cambio STATO (campo ATTIVO) a Listino
//---
...
on kuf_listino_cambio_stato.create
call super::create
end on

on kuf_listino_cambio_stato.destroy
call super::destroy
end on
